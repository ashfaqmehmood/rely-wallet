...
// solana.request({ method: "connect" }).then(e => console.info(e)).catch(e => console.info(e)).finally((e) => console.info(e));
// solana.request({ method: "signMessage", params: { message: encodedMessage, display: 'utf8' } }).then(e => console.info(e)).catch(e => console.info(e)).finally((e) => console.info(e));

export const getInjectedJavaScriptSolana = (chainId: string, networkVersion: string) => {
  console.log('getInjectedJavaScriptSolana' + 'chainId: ' + chainId + 'networkVersion: ' + networkVersion);
  return `(function () {
        try {
            ...
            if (typeof EthereumProvider === "undefined") {
                    ...
                    if (callback) {
                        if (data.type === "api-response") {
                            if (data.permission == 'qr-code') {
                                ...
                                } else if (data.permission == 'solana-web3') {
                                    window.solana.publicKey = data.data.publicKey;
                ...
                EthereumProvider.prototype.isGlow = true;
                ...
                EthereumProvider.prototype.emit = function (name, data) {
                    if (name == "chainChanged") {
                        console.log("chainChanged emitted");
                        console.log(data);
                        EthereumProvider.prototype.chainId = data;
                        console.log(EthereumProvider.prototype.chainId);
                        console.log(window.ethereum);
                    }
                    if (name == "networkChanged") {
                        console.log("networkChanged emitted");
                        console.log(data);
                        EthereumProvider.prototype.networkVersion = data;
                        console.log(EthereumProvider.prototype.networkVersion);
                        console.log(window.ethereum);
                    }
                    if (!this._events[name]) {
                        return
                ...
                EthereumProvider.prototype.connect = function (e) {
                    console.log("connect");
                    console.log(e);
                    ...
                    if (e?.onlyIfTrusted) {
                        console.log("onlyIfTrusted");
                        let publicKey = new solanaWeb3.PublicKey("AyFdKnJLKxatz4C65c6ww78qzCR2SgYh6UsUUbSCAMTv");
                        console.log(publicKey);
    
                        window.phantom.solana.publicKey = publicKey;
                        window.phantom.solana.isConnected = true;
                        
                        EthereumProvider.prototype.publicKey = publicKey;
                ...
                EthereumProvider.prototype.signMessage = function (message) {
                    console.log("signMessage");
                    alert("signMessage");
                    console.log(message);
                    return sendAPIrequest('sign-message', {message: message});
                    // return Promise.reject({ message: "User rejected aw", code: 4001 });
                };
            ...
            window.solana = new EthereumProvider();
            window.phantom = {
                solana: new EthereumProvider()
            };
            window.glow = new EthereumProvider();
            window.glowSolana = new EthereumProvider();
